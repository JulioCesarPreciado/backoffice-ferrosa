...
<div class="flex flex-wrap mt-6">
    ...
    <div class="w-full lg:w-12/12 px-4 mb-4">
        ...
        <x-input.image id='thumbnail' name='thumbnail' title='Thumbnail' :value='$create ? null : $item->thumbnail' :required=true
            :create='$create' :show='$show' :edit='$edit'>
        </x-input.image>
        {{-- END input thumbnail --}}
    </div>
    <div class="w-full px-4">
        <x-input.number id='percentaje' name='percentaje' title='percentaje' :value='$create ? null : $item->percentaje' :required=false
            :create='$create' :show='$show' :edit='$edit'>
        </x-input.number>
    </div>
